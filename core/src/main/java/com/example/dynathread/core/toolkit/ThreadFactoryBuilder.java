...
/**
 * 用于构建自定义线程工厂的建造者类，支持设置线程池名、优先级、是否为守护线程等属性
 */
public class ThreadFactoryBuilder {
    ...
    /**
     * 线程名前缀，如 "dynathread-"，线程名形如：dynathread-1
     */
    ...
    public ThreadFactory build() {
        ...
        /**
         * 返回的是一个lambda表达式，实现了 ThreadFactory 接口的 newThread(Runnable) 方法
         */
        return runnable -> {
