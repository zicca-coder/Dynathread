...
public class ThreadPoolExecutorBuilder {
     ...
     * 设置线程工厂
     *
     * @param namePrefix 线程名前缀，如 "dynathread-"，线程名形如：dynathread-1
     */
     ...
     *
     * @param namePrefix 线程名前缀（e.g. "dynathread-"），最终线程名为：dynathread-1、dynathread-2...
    ...
    public ThreadPoolExecutor build() {
        ...
        if (dynamicPool) {
            threadPoolExecutor = new DynaThreadExecutor(
                    threadPoolId,
                    corePoolSize,
                    maximumPoolSize,
                    keepAliveTime,
